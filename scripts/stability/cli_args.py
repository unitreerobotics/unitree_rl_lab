...
def add_lyapunov_train_args(parser):    
    ...
    parser.add_argument('--falsifier', action='store_true', help='Use pgd falsifier')
    ...
    parser.add_argument('--lyapunov_by_construction', action='store_true', default=False)
    parser.add_argument('--pct_counterexamples', type=float, default=0.3, help='Portion of counterexamples mixed into each batch (0-1).')
